...
const translations:Record<string,string>={
 ...
 "Dashboard":"Genel Bakış","Family Group":"Aile Grubu","Wishlists":"Dilek Listeleri","Transactions":"İşlemler","Budgets":"Bütçeler","Accounts":"Hesaplar","Goals":"Hedefler","Analytics":"Analizler","AI Assistant":"AI Asistanı","Settings":"Ayarlar",
 ...
 ,"Freelance income":"Serbest çalışma geliri","Investment income":"Yatırım geliri","Gift income":"Hediye geliri","Other income":"Diğer gelir","Health":"Sağlık","Education":"Eğitim","Subscriptions":"Abonelikler","Personal care":"Kişisel bakım","Travel":"Seyahat","Insurance":"Sigorta","Debt payments":"Borç ödemeleri","Gifts":"Hediyeler","Other expenses":"Diğer giderler","On track":"Yolunda","Nearly used":"Neredeyse tükendi","Limit exceeded":"Limit aşıldı","No budgets yet":"Henüz bütçe yok","Plan a monthly limit for each spending category.":"Her harcama kategorisi için aylık limit belirleyin.","Set a monthly spending limit and track it automatically.":"Aylık harcama limiti belirleyin ve otomatik takip edin.","Monthly limit":"Aylık limit","Month":"Ay","Select an expense category":"Bir gider kategorisi seçin","Saving…":"Kaydediliyor…","Budget updated.":"Bütçe güncellendi.","Budget created.":"Bütçe oluşturuldu.","Budget deleted.":"Bütçe silindi.","Loading budgets…":"Bütçeler yükleniyor…","Loading analytics…":"Analizler yükleniyor…","No expenses this month.":"Bu ay gider yok.","Create a budget to track it here.":"Takip etmek için bir bütçe oluşturun.","Current limits":"Güncel limitler","saved this month":"bu ay biriktirildi","Add income to calculate your savings rate.":"Tasarruf oranını hesaplamak için gelir ekleyin."
 ...
 ,"Compare each plan before choosing the features that fit your needs.":"İhtiyacına en uygun özellikleri seçmeden önce planları karşılaştır.","Full access during your trial":"Deneme süresince tüm özellikler açık","Every new account can use all Budget Buddy features during the trial, including AI, voice, family groups and CSV tools.":"Her yeni hesap deneme süresince AI, sesli kullanım, aile grupları ve CSV araçları dahil tüm Budget Buddy özelliklerini kullanabilir.","Start full trial":"Tüm özelliklerle dene","Start with your full trial access.":"Tüm özelliklerin açık olduğu deneme ile başla.","For connected money management.":"Daha kapsamlı para yönetimi için.","For deeper analysis and guidance.":"Daha derin analiz ve rehberlik için.","Everything in Free":"Ücretsiz plandaki her şey","Everything in Core":"Core plandaki her şey","Accounts and receipt uploads":"Hesaplar ve fiş yükleme","CSV import and export":"CSV içe ve dışa aktarma","Goals and family groups":"Hedefler ve aile grupları","Personal goals":"Kişisel hedefler","Family wishlists":"Aile dilek listeleri","Shared shopping list":"Ortak alışveriş listesi","Allowance plan":"Harçlık planı","Gift wishlists and shared shopping list":"Hediye dilek listeleri ve ortak alışveriş listesi","Voice questions":"Sesli sorular","Compare plans":"Planları karşılaştır","Choose the plan that fits your routine":"Düzenine uygun planı seç","Trial access is active":"Deneme erişimi aktif","Feature":"Özellik","Income and expense tracking":"Gelir ve gider takibi","Basic dashboard and budgets":"Temel genel bakış ve bütçeler","Savings goals and family groups":"Tasarruf hedefleri ve aile grupları","CSV import and data export":"CSV aktarma ve veri dışa aktarma","Advanced reports and filters":"Gelişmiş raporlar ve filtreler","AI Assistant and insights":"AI Asistanı ve içgörüler","Included":"Dahil","Included in trial":"Denemede dahil"
};
const transactionTranslations:Record<string,string>={"Transaction type":"İşlem türü","All types":"Tüm türler","All categories":"Tüm kategoriler","From date":"Başlangıç tarihi","To date":"Bitiş tarihi","Actions":"İşlemler","Edit":"Düzenle","Edit transaction":"İşlemi düzenle","Update the transaction details.":"İşlem bilgilerini güncelleyin.","Delete transaction":"İşlemi sil","Delete this transaction?":"Bu işlem silinsin mi?","No transactions yet":"Henüz işlem yok","Add your first income or expense to start tracking your money.":"Para takibine başlamak için ilk gelir veya giderinizi ekleyin.","Loading transactions…":"İşlemler yükleniyor…","Try again":"Tekrar dene","Save changes":"Değişiklikleri kaydet","Transaction updated.":"İşlem güncellendi.","Transaction deleted.":"İşlem silindi.","Unable to save the transaction.":"İşlem kaydedilemedi.","Unable to delete the transaction.":"İşlem silinemedi.","CSV import will be completed in the next phase.":"CSV aktarımı bir sonraki aşamada tamamlanacak."};
const accountTranslations:Record<string,string>={"Dashboard filters":"Genel bakış filtreleri","Scope":"Kapsam","Personal":"Kişisel","Period":"Dönem","checking":"Vadesiz hesap","savings":"Birikim hesabı","cash":"Nakit","credit_card":"Kredi kartı","digital_wallet":"Dijital cüzdan","Transfer out":"Giden transfer","Transfer in":"Gelen transfer","Monthly limit":"Aylık limit","Select an expense category":"Bir gider kategorisi seçin","Plan a monthly limit for each spending category.":"Her harcama kategorisi için aylık limit belirleyin.","Set a monthly spending limit and track it automatically.":"Aylık harcama limiti belirleyin ve otomatik takip edin."};
export const useT=()=>{const {language}=useContext(LanguageContext);return (text:string)=>language==="tr"?(translations[text]||transactionTranslations[text]||accountTranslations[text]||text):text};
